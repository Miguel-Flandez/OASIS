...
function fetchEmployeeStats($conn) {
    $stats = [
...
$stats = fetchEmployeeStats($conn);
$conn->close();

$employee_name = isset($_SESSION['employee_name']) ? htmlspecialchars($_SESSION['employee_name']) : 'Employee';
?>
...
<head>
    ...
    <meta name="description" content="Employee Dashboard for OASIS - Manage payments, accounts, and more.">
    <title>Employee Home - OASIS</title>
...
<body>
    ...
    <main class="p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Welcome, <?php echo $employee_name; ?>!</h1>
        ...
        <section id="graph-container" aria-label="Data Visualizations">
            <div class="chart-wrapper">
                ...
                <div id="distribution-no-data" class="no-data" style="display: none;">No unpaid fees data available.</div>
                <canvas id="paymentDistributionChart" aria-label="Payment Distribution Chart"></canvas>
            </div>
            <div class="chart-wrapper">
                <div id="trend-no-data" class="no-data" style="display: none;">No payment trend data available.</div>
    ...
    <script src="../js/employee-home.js"></script>
    <script>
